...
/// <summary>
/// PageExtension NCT CashReceiptJournal avg (ID 70409) extends Record Cash Receipt Journal.
/// </summary>
pageextension 70409 "NCT CashReceiptJournal avg" extends "Cash Receipt Journal"
{
    layout
    {
