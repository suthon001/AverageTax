/// <summary>
/// PageExtension NCT Avg. Purch. Invoice Line (ID 70400) extends Record Purch. Invoice Subform.
/// </summary>
pageextension 70400 "NCT Avg. Purch. Invoice Line" extends "Purch. Invoice Subform"
{
    layout
    {
