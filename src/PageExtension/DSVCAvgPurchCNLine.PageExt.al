...
/// <summary>
/// PageExtension DSVC Avg. Purch. CN Line (ID 70406) extends Record Purch. Cr. Memo Subform.
/// </summary>
pageextension 70406 "DSVC Avg. Purch. CN Line" extends "Purch. Cr. Memo Subform"
{
    layout
    {
        addafter(Description)
        {
            field("DSVC Average Tax Codeๅจ"; rec."DSVC Average Tax Code")
            {
                ApplicationArea = all;
